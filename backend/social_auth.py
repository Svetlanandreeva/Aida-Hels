...
class SocialAuthService:
    ...
    async def start(self, provider: str, return_uri: str) -> Dict[str, Any]:
        ...
        if provider == "yandex":
            ...
            # Mirror the default redirect URL generated by VK ID Web SDK 2.6.1.
            # Their own contract includes version/prompt/stats_info and omits
            # scope when it is not explicitly configured.
