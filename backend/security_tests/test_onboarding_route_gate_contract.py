...
def test_profile_gate_allows_all_onboarding_steps_until_completion():
    ...
    assert 'const ONBOARDING_ROUTES = new Set(["onboarding", "onboarding-medical", "onboarding-lifestyle", "onboarding-medications"]);' in source
    ...
    assert '<Stack.Screen name="onboarding-medications" />' in source
