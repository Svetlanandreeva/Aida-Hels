        ...
        >
          ...
          {!loading && !error && items.length === 0 ? (
            <View style={styles.empty}>
              ...
              <Muted style={styles.stateText}>{lang === "ru" ? "Здесь появятся медицинские документы, которые вы загрузите в профиль." : "Medical documents uploaded to this profile will appear here."}</Muted>
            </View>
          ) : (
