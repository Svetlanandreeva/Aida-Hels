...
export default function DocumentsScreen() {
  ...
  return <View style={mobileStyles.page}>
    ...
    <Sheet visible={open} onClose={() => !saving && setOpen(false)} testID="document-upload-sheet" scroll>
      ...
      {uploadError ? <FCard style={styles.errorCard}><Ionicons name="alert-circle-outline" size={20} color="#C64E5B" /><Txt variant="label" color="#C64E5B" style={{ flex: 1 }}>{uploadError}</Txt></FCard> : null}
