...
const styles = StyleSheet.create({
  ...
  wheel: { width: 220, height: 220, borderRadius: 110, borderWidth: 12, borderColor: colors.borderStrong, backgroundColor: colors.glassStrong, alignItems: "center", justifyContent: "space-around", flexDirection: "row", flexWrap: "wrap", padding: 32 },
  ...
  progress: { height: 8, borderRadius: 4, overflow: "hidden", backgroundColor: colors.surfaceTertiary, marginTop: spacing.md },
