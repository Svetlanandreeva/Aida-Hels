        ...
        {mode === "verify" ? (
          ...
          <>
            ...
            <View style={styles.form}>
              ...
              {mode !== "forgot" ? <><View style={styles.dividerRow}><View style={styles.dividerLine} /><Text style={styles.dividerText}>{ru ? "или" : "or"}</Text><View style={styles.dividerLine} /></View><SocialButton provider="vk" label={ru ? "Продолжить с VK ID" : "Continue with VK ID"} busy={socialBusy === "vk"} disabled={busy || socialBusy !== null} onPress={() => socialLogin("vk")} /></> : null}
